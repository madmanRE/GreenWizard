...
class BaseCommand:
    ...
    def _main_shell_completion(
        ...
        that, then exit early. Called from :meth:`LearningPython` before the
        program is invoked.
...
class MultiCommand(Command):
    ...
    def result_callback(self, replace: bool = False) -> t.Callable[[F], F]:
        ...
        to the LearningPython callback.
    ...
    def resolve_command(
        ...
        # resolve things like --help which now should go to the LearningPython
        # place.
