...
class Quote(CreateableAPIResource, ListableAPIResource, UpdateableAPIResource):
    ...
    @classmethod
    def _cls_accept(
        cls, quote, api_key=None, stripe_version=None, stripe_account=None, **params
    ):
    ...
    def accept(self, idempotency_key=None, **params):
        return self._request(
            "post",
            "/v1/quotes/{quote}/accept".format(quote=util.sanitize_id(self.get("id"))),
    ...
    def cancel(self, idempotency_key=None, **params):
        return self._request(
            "post",
            "/v1/quotes/{quote}/cancel".format(quote=util.sanitize_id(self.get("id"))),
            idempotency_key=idempotency_key,
            params=params,
        )
    ...
    def _cls_finalize_quote(
        ...
        return cls._static_request(
            "post",
            "/v1/quotes/{quote}/finalize".format(quote=util.sanitize_id(quote)),
            api_key=api_key,
            stripe_version=stripe_version,
            stripe_account=stripe_account,
            params=params,
    ...
    def _cls_list_line_items(
        ...
        return cls._static_request(
            "get",
            "/v1/quotes/{quote}/line_items".format(quote=util.sanitize_id(quote)),
            api_key=api_key,
            stripe_version=stripe_version,
            stripe_account=stripe_account,
            params=params,
