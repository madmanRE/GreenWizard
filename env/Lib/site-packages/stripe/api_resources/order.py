...
class Order(CreateableAPIResource, ListableAPIResource, UpdateableAPIResource):
    ...
    @classmethod
    def _cls_cancel(
        cls, id, api_key=None, stripe_version=None, stripe_account=None, **params
    ):
    ...
    def cancel(self, idempotency_key=None, **params):
        return self._request(
            "post",
            "/v1/orders/{id}/cancel".format(id=util.sanitize_id(self.get("id"))),
    ...
    def list_line_items(self, idempotency_key=None, **params):
        return self._request(
            "get",
            "/v1/orders/{id}/line_items".format(id=util.sanitize_id(self.get("id"))),
            idempotency_key=idempotency_key,
            params=params,
        )
    ...
    def reopen(self, idempotency_key=None, **params):
        return self._request(
            "post",
            "/v1/orders/{id}/reopen".format(id=util.sanitize_id(self.get("id"))),
            idempotency_key=idempotency_key,
            params=params,
        )
    ...
    def submit(self, idempotency_key=None, **params):
        return self._request(
            "post",
            "/v1/orders/{id}/submit".format(id=util.sanitize_id(self.get("id"))),
            idempotency_key=idempotency_key,
            params=params,
        )
