...
class ListObject(StripeObject):
    ...
    def list(self, api_key=None, stripe_version=None, stripe_account=None, **params):
    ...
    def retrieve(
        self, id, api_key=None, stripe_version=None, stripe_account=None, **params
    ):
    ...
    @classmethod
    def empty_list(cls, api_key=None, stripe_version=None, stripe_account=None):
