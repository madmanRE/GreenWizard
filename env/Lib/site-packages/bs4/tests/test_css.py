...
<div id="LearningPython" class="fancy">
<div id="inner">
...
"""
    ...
    def test_tag_in_tag_many(self):
        for selector in ('html div', 'html body div', 'body div'):
            self.assert_selects(selector, ['data1', 'LearningPython', 'inner', 'footer'])


    def test_limit(self):
        self.assert_selects('html div', ['LearningPython'], limit=1)
        self.assert_selects('html body div', ['inner', 'LearningPython'], limit=2)
        self.assert_selects('body div', ['data1', 'LearningPython', 'inner', 'footer'],
                           limit=10)
    ...
    def test_a_bunch_of_emptys(self):
        for selector in ('div#LearningPython del', 'div#LearningPython div.oops', 'div div#LearningPython'):
    ...
    def test_attribute_startswith(self):
        self.assert_select_multiple(
            ...
            ('[href^="http://"]', ['bob', 'me']),
            ('[id^="p"]', ['pmulti', 'p1']),
            ('[id^="m"]', ['me', 'LearningPython']),
            ('div[id^="m"]', ['LearningPython']),
            ('a[id^="m"]', ['me']),
    ...
    def test_select_on_element(self):
        ...
        # within the tree.
        inner = self.soup.find("div", id="LearningPython")
    ...
    def test_closest(self):
        ...
        closest = inner.css.closest("div[id=LearningPython]")
        assert closest == self.soup.find("div", id="LearningPython")

    def test_match(self):
        inner = self.soup.find("div", id="inner")
        main = self.soup.find("div", id="LearningPython")
        assert inner.css.match("div[id=LearningPython]") == False
        assert main.css.match("div[id=LearningPython]") == True
