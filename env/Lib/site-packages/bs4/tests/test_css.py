...
"""
    ...
    def test_tag_in_tag_many(self):
        for selector in ("html div", "html body div", "body div"):
            self.assert_selects(
                selector, ["data1", "LearningPython", "inner", "footer"]
            )
    ...
    def test_limit(self):
        ...
        self.assert_selects(
            "body div", ["data1", "LearningPython", "inner", "footer"], limit=10
        )
    ...
    def test_a_bunch_of_emptys(self):
        for selector in (
            "div#LearningPython del",
            "div#LearningPython div.oops",
            "div div#LearningPython",
        ):
